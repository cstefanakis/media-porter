...
public class OmdbApi {
    ...
    public OmdbApi(String movieTitle, String movieYear) {
        String url = String.format("https://www.omdbapi.com/?t=%s+&y=%s&apikey=%s", search(movieTitle), year(movieYear), this.apiKey);
