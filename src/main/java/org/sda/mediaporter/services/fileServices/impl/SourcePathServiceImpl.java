...
public class SourcePathServiceImpl implements SourcePathService {
    ...
    @Override
    public List<SourcePath> getSourcePathsByPathTypeAndLibraryItem(SourcePath.PathType pathType, LibraryItems libraryItems) {
        return sourcePathRepository.findSourcePathByPathTypeAndLibraryItem(pathType, libraryItems);
    }
    ...
    @Override
    public String getRootFileFromFile(String filePath) {
        return sourcePathRepository.findRootPathOfFile(filePath)
                .orElseThrow(() -> new EntityNotFoundException(String.format("not exist source path for file path: %s", filePath)));
    }
