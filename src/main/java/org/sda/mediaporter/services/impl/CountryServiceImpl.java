...
public class CountryServiceImpl implements CountryService {
    ...
    @Override
    public List<Country> getCountriesByCodes(List<String> countriesCodes) {
        return countriesCodes.stream()
                .map(this::getCountryOrNullByCode).toList();
    }

    private Country getCountryOrNullByCode(String countryCode){
        try{
    ...
    @Override
    public Country getCountryByCodeOrNull(String countryCode) {
        return countryRepository.findCountryByCode(countryCode).orElse(null);
    }
