...
public class LanguageServiceImpl implements LanguageService {
    ...
    @Override
    public Language getLanguageByCodeOrTitle(String languageCodeOrTitle) {
        return languageRepository.findByCodeOrTitle(languageCodeOrTitle).orElseThrow(
                ()-> new EntityNotFoundException(String.format("Language with code or title: %s not found",languageCodeOrTitle)));
    }
