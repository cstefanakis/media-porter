...
class ResolutionServiceTest {
    ...
    @Test
    void autoCreateResolution_createNewResolution(){
        //Assert
        String resolutionName = "4k";

        //Act
        Resolution createdResolution = resolutionService.autoCreateResolution(resolutionName);

        //Assert
        assertNotNull(createdResolution.getId());
        assertEquals(resolutionName, createdResolution.getName());
    }

    @Test
    void autoCreateResolution_getExistResolution(){
        //Assert
        String existResolutionName = "720p";

        //Act
        Resolution createdResolution = resolutionService.autoCreateResolution(existResolutionName);

        //Assert
        assertEquals(existResolutionName, createdResolution.getName());
    }
}